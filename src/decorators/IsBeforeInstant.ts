 ...
 */
export function IsBeforeInstant(target: Date, validationOptions?: ValidationOptions) {
...
export function errorMessage(vc: ValidationContext, o: any):string {
  ...
  const messageLiteral: string = `should come before ${vc.validationParameters[0]}`;
